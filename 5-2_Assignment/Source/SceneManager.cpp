...
void SceneManager::LoadSceneTextures()
{
	...
	CreateGLTexture("../../Utilities/textures/abstract.jpg", "cone");
	CreateGLTexture("../../Utilities/textures/tilesf2.jpg", "tilebox");
	CreateGLTexture("../../Utilities/textures/stainedglass.jpg", "sphere");
